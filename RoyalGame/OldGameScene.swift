...
class GameScene: SKScene {
    ...
    let dieSize: CGFloat?
    let idealTileSize = 114.0 as CGFloat
        ...
        */
        ...
        for player in [1,2] {
            ...
            for i in 0..<7 {
                ...
                sprite.setScale(1/2 * TileSize!/idealTileSize)
                sprite.zPosition = 11
    ...
    */
    ...
    func addRosette(rank: Int, side: Int) {
        ...
        sprite.setScale(2/3 * TileSize!/idealTileSize)
        sprite.zPosition = 13
    ...
    */
    ...
    func updateScreen() {
        ...
        let diceInrect = dice.childNode(withName: "In Rect")! as! SKSpriteNode
        ...
        for token in self.data.tokens {
            if let sprite = token.sprite {
                ...
                token.sprite!.setScale(1/2 * TileSize!/idealTileSize)
